...
import ru.example.startandroid.develop.fitnesstracker.direction.GetDirections;
...
public class MapFragment extends Fragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        start.setOnClickListener(this::startChronometer);
        //тут был метод
    ...
    public class AddRunAsyncTask extends AsyncTask<Void, Void, Void> {
        private MapDao dao;

        AddRunAsyncTask(MapDao dao) {
            this.dao = dao;
        }
        ...
        protected Void doInBackground(Void... voids) {
            if (this == null) {
                Map run = new Map(length, speed, time);
                dao.insert(run);
            }
            return null;
        }
